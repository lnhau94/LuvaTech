...
public class phoneDetails {
        ...
        ArrayList<PhoneVariant> laptopVariants;
        HashSet<String> rams;
        ...
        public void setData(Phone product) throws IOException {
            ...
            for(PhoneVariant item : laptopVariants){
        ...
        public void Description(Phone laptop){
        ...
        public cartPage cart(Phone product ) {
